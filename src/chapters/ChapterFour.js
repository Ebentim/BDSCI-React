        ...
        <div>
          <div className="courseContents">
            ...
            <p className="courseText">
              ...
              guiding drivers through intersections and ensuring the smooth flow
              of vehicles. As drivers, it is crucial to recognize and understand
              the significance of these traffic control signals to navigate the
              roads safely
            </p>
            <ReactPlayer
            ...
            <p className="sectionQuote">
              Traffic controls serve as the silent conductors of the symphony of
              movement, orchestrating the flow of vehicles with precision and
              purpose.
            </p>
            <p className="courseText">
              ...
              respond to hazards, and make informed decisions. Let's explore the
              significance of traffic control signals and their various
              functions
            </p>
            <iframe
            ...
            <p className="courseText">
              ...
              establish rules for the road. They indicate when to stop, proceed,
              or yield, ensuring orderly movement and reducing the risk of
              collisions. Adhering to these regulations is essential for
              maintaining a smooth and safe traffic flow.
            </p>
            <h5 className="sectionSubheading">Warning</h5>
            <p className="sectionQuote">
              Warnings in the form of flashing lights and signs act as vigilant
              sentinels, alerting drivers to potential dangers and calling for
              caution on the road.
            </p>
            <p className="courseText">
              Traffic control devices like flashing yellow lights, construction
              signs, and temporary barricades serve as warnings. They notify
              drivers of upcoming hazards, such as road work, pedestrian
              crossings, or hazardous road conditions. Being attentive to these
              warnings allows drivers to adjust their speed, exercise caution,
              and stay prepared for potential risks.
            </p>
            <h5 className="sectionSubheading">Information</h5>
            <p className="sectionQuote">
              Road signs and markings stand as silent messengers, conveying
              directions, speed limits, and crucial information to help you make
              informed choices on your journey.
            </p>
            <img
              src={directions}
            ...
            <p className="sectionQuote">
              Guidance signals, steer drivers on the right path, directing lane
              changes, merges, and exits with clarity and efficiency.
            </p>
            <p className="courseText">
              ...
              Lane markings, arrows, and signs help drivers understand where to
              go, how to merge, which lane to use, and when to exit. Adhering to
              these guidance signals ensures smoother traffic flow, minimizes
              conflicts, and reduces the likelihood of wrong maneuvers.
            </p>
            <iframe
            ...
            <p className="courseText">
              ...
              based on fixed time or vehicle actuation. Traffic control signals
              are used to control the flow of vehicular and pedestrian traffic,
              prevent excessive delays, and assign the right-of-way.
            </p>
            <ReactPlayer
            ...
            <p className="sectionQuote">
              The red, yellow, and green lights of traffic signals communicate a
              language of order and safety, dictating the ebb and flow of
              vehicles at intersections
            </p>
            <p className="courseText">
              Traffic lights are the most common form of traffic control
              signals. They consist of red, yellow, and green lights that
              regulate the flow of traffic at intersections and other points on
              the road. Each color has a specific meaning:
            </p>
            <iframe
            ...
            ></iframe>
            <p className="courseText">
              <span className="bolf">Red: </span>Requires vehicles to come to a
              complete stop behind the stop line or at the intersection. Drivers
              must remain stopped until the light changes to green.
            </p>
            <p className="courseText">
              <span className="bolf">Yellow: </span>Indicates that the light is
              about to change from green to red. It serves as a warning for
            ...
            <p className="courseText">
              ...
              through the intersection or along the road, but drivers must yield
              to pedestrians and oncoming traffic before proceeding.
            </p>
            ...
            <p className="courseText">
              <span className="bold">Green Arrow</span> Allows vehicles to turn
              in the direction indicated by the arrow. Drivers have the right of
              way and can proceed with the turn when it is safe to do so.
            </p>
            <p className="courseText">
              <span className="bold">The yellow arrow</span> Warns drivers that
              the green arrow is about to change to red. It advises caution and
              requires drivers to prepare to stop or complete the turn,
            ...
            <p className="courseText">
              ...
              complete stop, yield to cross traffic or pedestrians, and proceed
            ...
            <p className="sectionQuote">
              The luminous lane signals serve as beacons of guidance, revealing
              which paths are open for traversing and which must be left behind.
            </p>
            <p className="courseText">
            ...
            <p className="courseText">
              Intersection safety is a road safety priority because according to
              the United States Federal Highway Administration, more than 50% of
              harmful and fatal crashes occur at or near an intersection.
              Intersections create conflict points where traffic moves against
              and across itself, and pedestrian and bicycle safety depends on
              following traffic rules. Some safety measures include separating
              road users in time and space with signals, crosswalks, and bicycle
              crossings. Drivers should keep a safe distance, inspect the
              intersection, and be patient at every intersection.
            </p>
            <ReactPlayer
            ...
            <p className="courseText">
              Before reaching an intersection, drivers should actively scan for
              traffic controls, such as stop signs, yield signs, and traffic
              signals. Additionally, they should be aware of any prohibitive
              signs, such as no-entry or no-turn signs, which dictate specific
              actions at the intersection. Scanning for these signs helps
              drivers anticipate their obligations and make informed decisions.
            </p>
            <p className="courseText">
              <span className="bold">Scan for potential hazards:</span>A
              thorough scan for potential hazards is crucial when approaching
              and navigating intersections. This includes checking for oncoming
              traffic, pedestrians, cyclists, and any other potential
            ...
            <p className="courseText">
              ...
              attentive to traffic signal changes. A yellow light indicates that
              the signal is transitioning from green to red. Drivers should
              exercise caution and be prepared to stop safely if it is unsafe to
              proceed through the intersection before the light turns red. If
              the driver can safely clear the intersection without endangering
              themselves or others, they may proceed with caution.
            </p>
            <h5 className="sectionSubheading">D. Controlled intersections:</h5>
            <p className="courseText">
            ...
            <ol className="orderedList">
              <li className="courseText">
                ...
                provide clear indications of when to stop, proceed, or yield at
                an intersection. Drivers must adhere to the signals and follow
                the appropriate lanes indicated by the signal lights.
              </li>
              <li className="courseText">
                ...
                temporary changes in traffic patterns. Drivers should pay close
                attention to these signals and adjust their driving accordingly.
              </li>
              <li className="courseText">
                <span className="bold"> Circular arrows:</span> Circular arrows,
                often seen in conjunction with signal lights, indicate that a
                specific lane or lanes have the right-of-way to proceed in a
                particular direction. Drivers should follow the direction of the
                circular arrow and yield appropriately to other vehicles when
                necessary.
              </li>
              <li className="courseText">
              ...
              <li className="courseText">
                ...
                should position their vehicles in the appropriate lanes well in
                advance and adhere to lane markings to ensure smooth and safe
                traffic flow.
              </li>
            </ol>
            ...
            <p className="courseText">
              <span className="bold">Yellow curbs</span> indicate loading zones
              or areas with time-limited parking.
            </p>
            <p className="courseText">
              <span className="bold">Red curbs</span> signify no-parking zones,
              fire lanes, or areas with restricted access
            </p>
            <p className="courseText">
            ...
            <ul>
              ...
              <li className="courseText">
                ...
                curbs can designate areas specifically designated for passenger
                loading and unloading, allowing for a brief stop to drop off or
                pick up passengers.
              </li>
              <li className="courseText">
                Other designations: White curbs may be used to convey additional
                information or restrictions depending on local regulations, such
                as time-limited parking, specific vehicle types, or loading and
                unloading zones for certain goods or services.
              </li>
            </ul>
            <p className="courseText">
              <span className="bold">Placement:</span> Curb markings are placed
              along the edge of the roadway or pavement to indicate specific
              rules and regulations associated with that particular section.
              They may include painted words, symbols, or lines that provide
              instructions or restrictions regarding parking, stopping, or other
              activities.
            </p>
            ...
            <p className="courseText">
              ...
              markings, typically white lines on the right side and yellow lines
              on the left side indicate the boundary of the roadway. They serve
              to guide drivers and provide a clear visual reference for staying
              within the designated roadway area.
            </p>
            ...
            <p className="courseText">
              <span className="bold">Purpose: </span>Yellow markings are used to
              highlight obstructions or hazards on the roadway, such as islands,
              medians, or raised curbs. These markings alert drivers to the
              presence of potential obstacles and help guide them safely around
              or past the obstruction.
            </p>
            ...
            <p className="courseText">
              <span className="bold">Purpose: </span>Stop lines are solid white
              lines that indicate where vehicles must come to a complete stop at
              an intersection or before crossing a pedestrian crosswalk. They
              serve as an apparent visual reference for drivers, ensuring proper
              positioning and compliance with traffic control signals.
            </p>
            ...
            <p className="courseText">
              <span className="bold">Purpose: </span>Crosswalk markings consist
              of white lines that indicate areas designated for pedestrian
              crossings. They provide a visible and defined path for pedestrians
              and alert drivers to the presence of pedestrians crossing the
              roadway, promoting safety and facilitating the right-of-way.
            </p>
            ...
            <p className="courseText">
              <span className="bold">Purpose: </span>Railroad crossing markings
              are used to indicate the presence of a railroad crossing ahead.
              They consist of a series of white or yellow lines and "X" symbols
              painted on the pavement. These markings serve as a visual warning
              to drivers, reminding them to exercise caution, reduce speed, and
              be prepared to stop for approaching trains.
            </p>
            ...
            <p className="courseText">
              ...
              signage, crosswalk markings, and school zone speed limit markings.
              They help raise awareness of school zones, indicating areas where
              children may be present, and encouraging drivers to exercise
              increased caution and comply with reduced speed limits.
            </p>
            ...
            <p className="courseText">
              ...
              create a dedicated space for cyclists, increasing their visibility
              and safety. Green-colored markings are often used to highlight
              conflict areas where vehicles might intersect with the bicycle
              lane.
            </p>
            ...
            <p className="courseText">
              <span className="bold">Purpose: </span>Shared lane markings, also
              known as "sharrows," indicate that the lane is shared by both
              bicycles and motor vehicles. These markings typically consist of
              chevron symbols and serve as a reminder for drivers to share the
              road with cyclists.
            </p>
            ...
            <p className="courseText">
              ...
              such as speed humps, speed tables, or raised crosswalks, may have
              unique colors or patterns to visually indicate the presence of
              these measures. They aim to reduce vehicle speeds, enhance
            ...
            <p className="courseText">
              <span className="bold">Purpose: </span>Pavement markings are used
              to indicate designated parking spaces, including parallel, angled,
              or perpendicular parking. These markings provide visual cues for
              drivers, ensuring proper positioning of vehicles and maximizing
              the efficient use of parking spaces.
            </p>
            ...
            <p className="courseText">
              <span className="bold">Purpose: </span> Lane restriction markings,
              such as solid red "X" symbols or diagonal yellow lines, indicate
              temporary or permanent lane closures or restrictions. These
              markings warn drivers of the lane closure ahead, promoting safety
              and directing traffic flow in construction zones or areas of
              restricted access.
            </p>
            ...
            <p className="courseText">
              Railroad safety is of utmost importance, as trespassing on tracks
              and property can lead to fatal consequences. Each year,
              approximately 500 people lose their lives while trespassing on
              railroad tracks. To avoid such potential dangers, it is crucial to
              stay away from railroad tracks unless using designated crossings.
            </p>
            <p className="courseText">
              Comparing the risks,{" "}
              ...
              reveals that the odds of dying in a motor-vehicle crash were 1 in
              107 in 2019. In contrast, the odds of dying in a railway accident
              were 1 in 8,000. This alarming statistic indicates that
              individuals are about 75 times more likely to be killed in a crash
              involving a train than in a collision involving another motor
              vehicle.
            </p>
            <p className="courseText">
              The number of fatalities resulting from highway-rail crashes
              exceeds those from commercial airline crashes in an average year.
              This striking comparison underscores the significance of rail
              crossing safety and the imperative for drivers to exercise caution
              and adhere to safety measures at railroad crossings.
            </p>
            <p className="courseText">
              Consider the stopping distance of trains, which is another
              critical factor. On average, it takes a train over a mile to come
              to a complete stop. This extensive stopping distance emphasizes
              the need for allowing sufficient time and distance to safely cross
              railroad tracks.
            </p>
            <p className="courseText">
              Contrary to common belief, the majority of vehicle-train crashes
              occur when the train is traveling at speeds less than 30 miles per
              hour. This unexpected finding highlights the necessity of caution
              and attentiveness at all railroad crossings, regardless of the
              train's speed.
            </p>
            <p className="courseText">
            ...
            />
            <p className="courseText">
              Railroad crossings have two basic types of warnings: passive signs
              and active signs. Passive signs include round yellow warning
              signs, pavement markings, crossbuck signs, stop signs, and yield
              signs.{" "}
            ...
            <ol className="orderedList">
              <li className="courseText">
                Flashers - they mean stop Flashing lights at a railroad crossing
                indicate that a train is approaching, and motorists must come to
                a complete stop before the tracks.
              </li>
              <li className="courseText">
                Crossing gate - don't drive around: Crossing gates are physical
                barriers that lower to block the road when a train is
                approaching. It is crucial to never attempt to drive around a
                lowered crossing gate, as it indicates an active train crossing.
              </li>
              <li className="courseText">
                Crossing sign: A yellow and black crossing sign alerts drivers
                to an upcoming railroad crossing, providing an advanced warning
                to prepare for a potential stop.
              </li>
            </ol>
            <h5 className="sectionSubheading">
            ...
            <p className="courseText">
              <span className="bold">Never stop on railroad tracks: </span> let
              traffic ahead clear before trying to cross tracks. It is essential
              to ensure that there is sufficient space on the other side of the
              tracks before proceeding, avoiding the risk of being trapped on
              the tracks in the presence of an oncoming train.
            </p>
            <p className="courseText">
              <span className="bold">
            ...
            <p className="courseText">
              ...
              Walking on or near railroad tracks is extremely dangerous and can
              lead to fatal accidents. Pedestrians should always use designated
              crossings or alternate routes to ensure their safety.
            </p>
            <p className="courseText">
              <span className="bold">When crossing multiple tracks</span>wait a
              few seconds after a train has passed to be sure there isn't one
              traveling the other way. Multiple tracks may be present at some
              crossings, and it is crucial to verify that no other trains are
              approaching from a different direction before proceeding.
            </p>
            <p className="courseText">
              ...
              dangerous and significantly increases the risk of a collision. It
              is important to prioritize safety over saving time.
            </p>
            <p className="courseText">
              <span className="bold">
                If your vehicle stalls on tracks -get out:{" "}
              </span>
              Only attempt to restart if you can post someone outside the car to
              watch for trains. In the event of a vehicle stalling on railroad
              tracks, it is essential to exit the vehicle promptly and move to a
              safe location. If it is possible to restart the vehicle, it should
              only be done if someone can provide a lookout for approaching
              trains.
            </p>
            <p className="courseText">
              <span className="bold">
              ...
              Large objects, such as trains, may appear to be moving slower than
              they are due to their size. It is important not to misjudge the
              speed and distance of an approaching train and to allow ample time
              for a safe crossing.
            </p>
            ...
            <ol className="orderedList" type="a">
              ...
              <li className="courseText">
                ...
                stops. This is a safety measure to alert other drivers that the
                bus is making a stop and children may be present.
              </li>
              <li className="courseText">
                Always obey hand signals and other instructions of school bus
                drivers. The drivers are responsible for the safety of the
                children, and following their instructions helps maintain order
                and safety during bus stops.
              </li>
              <li className="courseText">
                Be as courteous as possible to school buses and give them the
                right of way whenever possible. School buses often make frequent
                stops, so being patient and allowing them to proceed can help
                ensure the safety of everyone.
              </li>
              <li className="courseText">
                Do not pull out in front of school buses or otherwise cause them
                to maneuver abruptly. It's important to maintain a safe distance
                from school buses and avoid any actions that may force them to
                make sudden or unexpected maneuvers.
              </li>
              <li className="courseText">
                ...
                front of you. Children can be unpredictable, and it's crucial to
                exercise caution when driving near a stopped school bus, as
                children may be crossing the road.
              </li>
              <li className="courseText">
                Treat school bus stops as school zones; drive 25 M.P.H. or less
                if children are present. School bus stops are areas where
            ...
            <p className="courseText">
              ...
              Signs with a red, black, or red-on-white color combination convey
              important messages. Red is universally recognized as a signal to
              stop or prohibit certain actions, while black and white contrast
              provides clear visibility. These signs can indicate stop signs,
              yield signs, or prohibitions, alerting drivers to necessary
            ...
            <p className="courseText">
              <span className="bold">Motorists' Services: </span>Blue signs are
              typically used to indicate services available to motorists, such
              as gas stations, rest areas, hospitals, or food services. These
              signs provide drivers with essential information about nearby
            ...
            <p className="courseText">
              ...
              symbol of a railroad crossing indicate the presence of a railroad
              crossing ahead. They warn drivers to be cautious and prepared to
              stop for oncoming trains.
            </p>
            <p className="courseText">
              <span className="bold">Vertical rectangle: </span>Signs with a
              vertical rectangular shape convey regulatory information, such as
              speed limits, parking restrictions, or one-way streets.
            </p>
            <p className="courseText">
            ...
            <p className="courseText">
              ...
              indicate no passing zones, warning drivers not to overtake or pass
              other vehicles in specific areas.
            </p>
            <p className="courseText">
