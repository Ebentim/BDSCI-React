  ...
  const NextButton = () => {
    return (
      <NavButtons onclick={handleClick} classname="nextButton">
        {!content ? "Continue to Lession" : "Understand the Purpose"}
      </NavButtons>
    );
  };
  return (
    <div className="courseBody" id="two">
      ...
      <div className="courseContentContainer">
        ...
        <div>
          {!content ? (
            <p className="purpose">
              <span className="bold">Purpose: </span>This unit delves into the
              multifaceted aspects of driver physiology and psychology. By
              exploring the physiological and psychological factors that
              influence driving behavior, this unit aim to equip you with the
              essential knowledge you need for a safe and responsible driving.
            </p>
          ) : (
