        ...
        <div>
          <div className="courseContents">
            ...
            <p className="courseText">
              ...
              accidents and misfortunes happen to others, not people in your age
              group. The underdeveloped prefrontal cortex during adolescence
              contributes to this perception, affecting your ability to assess
            ...
            <p className="courseText">
              Teenage drivers are prone to engaging in dangerous behaviors that
              include texting while driving, which diverts their attention from
              the road, and speeding, which impairs their ability to react to
              sudden changes. Reckless driving, drunk or impaired driving, and
              neglecting to wear seat belts also contribute to the alarming
              trend.
            </p>
            <p className="courseText">
              These dangerous behaviors can be attributed to factors such as
              peer pressure, a desire for excitement, and limited experience in
              evaluating risks.
            </p>
            <h5 className="sectionSubheading">C. False Sense of Security</h5>
            <p className="courseText">
              Teenagers' risk-taking behavior can also be influenced by a false
              sense of security stemming from modern vehicle safety features.
              While advancements in automotive technology have improved safety,
              you might overestimate the level of protection provided by these
              features.
            </p>
            <p className="courseText">
              ...
              and reckless behavior. This false sense of security can result in
              reduced risk perception and a disregard for other safety
              practices.
            </p>
            ...
            <p className="courseText">
              Distractions, especially from smartphones and social media, pose a
              significant threat to your focus on the road. Moreover, peer
              pressure and intense emotions can lead to reckless behaviors
              behind the wheel.
            </p>
            <h5 className="sectionSubheading">E. Showing off for passengers</h5>
            <p className="courseText">
              Attempting to impress passengers can lead to distractions inside
              the vehicle, diverting your attention from the road and increasing
            ...
            <p className="courseText">
              ...
              risky maneuvers without consequences, overestimating your driving
              abilities. Coupled with your limited driving experience, this
              eagerness to impress can elevate the risks and lead to accidents
              and injuries.{" "}
            </p>
            <h5 className="sectionSubheading">
            ...
            <p className="courseText">
              ...
              and challenging scenarios may struggle to respond appropriately to
              unexpected events. Additionally, their ability to anticipate
            ...
            <p className="courseText">
              ...
              the risk of accidents and injuries. Sensation-seeking behavior and
              the desire to impress peers can drive this risky behavior, leading
              some teenagers to engage in speeding, stunts, or other dangerous
              maneuvers for excitement and acceptance.
            </p>
            <p className="courseText">
            ...
            <p className="courseText">
              A critical factor in risk perception among young drivers is their
              limited ability to recognize and assess potentially unsafe driving
              conditions. Due to factors like limited experience, ongoing
              cognitive development, overconfidence, and external distractions,
              you may struggle to accurately evaluate risks on the road.
            </p>
            <p className="courseText">
              Limited driving experience means you may not have encountered
              various road and weather conditions, making it challenging for you
              to identify potential dangers. Additionally, the cognitive
              processes involved in risk perception continue to develop during
              adolescence, influencing your ability to assess risks accurately.
            </p>
            <h5 className="sectionSubheading">
            ...
            <p className="courseText">
              ...
              emotional distractions while behind the wheel. Additionally, peer
              influence can exert pressure on young drivers to conform to
            ...
            <p className="courseText">
              ...
              open roads or highways. However, driving at higher speeds reduces
              their ability to react to unexpected situations and increases
              stopping distances, escalating the severity of potential
              accidents.
            </p>
            <p className="courseText">
              Following the vehicle in front too closely is a concerning
              behavior among young drivers. Stemming from impatience or a belief
              that it will prompt other drivers to move out of their way,
              tailgating diminishes the driver's capacity to respond to sudden
              stops by the leading vehicle and can escalate minor incidents into
              more severe collisions.
            </p>
            <p className="courseText">
              Moreover, misuse of headlights, either by failing to use them when
              required (e.g., during low light conditions) or by inappropriately
              using excessively bright high beams is improper. Improper
              headlight use impairs the visibility of other drivers, leading to
              glare and distractions, which can heighten the risk of accidents.
            </p>
            ...
            <p className="courseText">
              ...
              willingness to take risks, leading to behaviors like speeding and
              aggressive driving. Young male drivers, especially teenagers and
              those in their early twenties, historically have higher crash
              rates due to their risk-taking tendencies.
            </p>
            <p className="courseText">
              On the other hand, some studies have indicated that female drivers
              may be more prone to distracted driving behaviors, such as talking
              on the phone.
            </p>
            <h5 className="sectionSubheading">E. “No One Got Hurt” Attitude</h5>
            <p className="courseText">
              This attitude refers to the belief that engaging in risky driving
              behaviors or violating traffic rules is acceptable as long as no
              immediate harm or accident occurs.
            </p>
            <p className="courseText">
              ...
              Drivers may underestimate the risks associated with their actions,
              believing that if they don't cause an accident immediately, their
              behavior is not harmful.
            </p>
            <h5 className="sectionSubheading">
            ...
            <p className="courseText">
              ...
              general disregard for consequences, a lack of empathy, a negative
              outlook, and impulsivity. Drivers with this mindset may be more
              likely to engage in risk-taking behaviors, exhibit distracted
              driving, and make reckless decisions on the road.
            </p>
            ...
            <p className="courseText">
              ...
              and consideration. Practice mindfulness while driving to focus on
              the road and your emotions.
            </p>
