...
export default function One (){
    ...
    return(
        <div className="quizBody">
            ...
            option1="Slowing down to look at collision scene" 
            option2="Avoiding unnecessary lane changes" 
            option3="Slowly pass vehicles that seem to be stopped for no reason" name="six" optionDiv="option" 
            ida="sixA" 
            idb="sixB" 
            idc="sixC"
            ...
            option3="Drink coffee to make you more alert" name="seven" optionDiv="option" 
            ida="sevenA" 
            idb="sevenB" 
            idc="sevenC"
            ...
            option3="It is illegal unless you wait in the vehicle" name="eight" optionDiv="option" 
            ida="eightA" 
            idb="eightB" 
            idc="eightC"
            ...
            option3="Transformation of social interactions and the ability to live farther from city centers" name="nine" optionDiv="option" 
            ida="nineA" 
            idb="nineB" 
            idc="nineC"
            ...
            option3="By generating employment opportunities, contributing to economic growth, and fostering interdependence with other sectors" name="ten" optionDiv="option" 
            ida="TenA" 
            idb="TenB" 
            idc="TenC"
